...
const guides = [
    ...
    //{ name: "Titan's Grip", tags: ["dps", "pve", "raid", "dungeon", "meele"], res: ["1x Divine Strength", "3x Improved Execute", "3x Sudden Death", "1x Cut to the Chase", "1x Deadliness", "3x Focused Rage", "1x Crusade", "1x Survival of the Fittest", "1x Killer Instinct", "1x A Quick Death"], notes: [], link:""},
    ...
    //{ name: "Prayer of Healing", tags: ["heal", "pve", "raid", "dungeon", "caster"], res: [], notes: [], link: "" },
